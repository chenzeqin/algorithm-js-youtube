    ...
    sidebar: [
      ...
      },
      {
        ...
        items: [
          ...
          { text: '前k个高频元素', link: '/10-堆/10.4-前k个高频元素' },
          { text: '合并k个排序链表', link: '/10-堆/10.5-合并k个排序链表' },
        ]
      },
      {
        text: '排序和搜索',
        items: [
          { text: '排序和搜索简介', link: '/11-排序和搜索/11.1-排序和搜索简介' },
          { text: '冒泡排序', link: '/11-排序和搜索/11.2-冒泡排序' },
        ]
      }
    ],

    socialLinks: [{ icon: 'github', link: 'https://github.com/chenzeqin/algorithm-js-youtube' }],
  },
});
